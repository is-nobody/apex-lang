...
static const BuiltinSig BUILTINS[] = {
    ...
    {"os.get_current_folder", 0, 0, TYPE_ANY},    {"os.set_current_folder", 1, 1, TYPE_STRING},
    {"os.terminate_process",  1, 1, TYPE_NUMBER}, {"os.execute",            1, 1, TYPE_STRING},
    {"os.read",               1, 1, TYPE_STRING}, {"os.write",              2, 2, TYPE_STRING},
    {"os.append",             2, 2, TYPE_STRING}, {"os.exists",             1, 1, TYPE_STRING},
    {"os.isfile",             1, 1, TYPE_STRING}, {"os.isfolder",           1, 1, TYPE_STRING},
    ...
    {"os.parentfolder",       1, 1, TYPE_STRING}, {"os.access",             2, 2, TYPE_STRING},
    ...
    {"sys.homedir",           0, 0, TYPE_ANY},    {"sys.apex_version",      0, 0, TYPE_ANY},
    {"sys.executable",        0, 0, TYPE_ANY},    {"sys.disksize",          0, 0, TYPE_STRING},
    {"sys.tempdir",           0, 0, TYPE_ANY},    {"sys.isterminal",        0, 0, TYPE_ANY},
    ...
    {"math.isnan",    1, 1, TYPE_NUMBER}, {"math.isinf",    1, 1, TYPE_NUMBER},
    ...
    {"crypto.random_hex", 1, 1, TYPE_NUMBER},      {"crypto.random_integer", 1, 1, TYPE_NUMBER},
