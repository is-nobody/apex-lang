...
static int codegen_literal_number(CodeGenerator* cg, ASTNode* node) {
    ...
    if (val == (int)val && val >= 0 && val <= 255) {                       // fits in immediate
...
static int codegen_call(CodeGenerator* cg, ASTNode* node) {
    ...
    static const char* builtins[] = {
        ...
        "math.isnan", "math.isinf",                  "math.trunc", "math.pow",
        ...
        "string.upper", "string.sub",                "string.split", "string.join",
        ...
        "random.expovariate", "random.betavariate",  "random.secure_token_hex", "random.secure_randint",
        "random.compare_digest",
