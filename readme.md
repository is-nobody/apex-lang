...
[![Apex Version](https://img.shields.io/badge/Apex-26.08-blue)](https://github.com/is-nobody/apex-lang)
...
- **Built-in Power:** Comes with a comprehensive standard library (`os`, `sys`, `math`, `string`, `table`, `ffi`, `random`, `json`, `xml`, `csv`, `hex`, `base`, `regex`, `crypto`) out of the box.
